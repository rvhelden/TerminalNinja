...
public sealed class DataGrid : Selector
{
    ...
    protected override void OnRender(CellBuffer buffer, Rect parentBounds)
    {
        ...
        // No focus visual here on purpose: the grid owns every cell in its bounds for content, so
        // anything it drew to show focus would overpaint the header row and the first and last
        // character of every row. Focus is shown by the Border around it — see Border.ContainsFocus.
    }
