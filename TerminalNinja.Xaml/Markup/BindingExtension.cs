...
{
    // Static storage for pending bindings during XAML parsing
    private static readonly Dictionary<BindingKey, BindingInfo> _pendingBindings = new();
    ...
    /// <summary>
    /// Gets all pending bindings and clears the internal storage.
    ...
    {
        var bindings = new Dictionary<BindingKey, BindingInfo>(_pendingBindings);
